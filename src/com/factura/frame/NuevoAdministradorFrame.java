...
public class NuevoAdministradorFrame extends javax.swing.JFrame {
    ...
    private void grabar() {
        if (validar()) {
            ...
            try {
                new AdministradorService().saveAdministrador(adm);
            } catch (Exception ex) {
    ...
    private void limpiarCampos() {
        Integer codigo = codigoSiguiente() + 1;
    ...
    private Integer codigoSiguiente() {
        Integer cod;
        try {
            cod = new AdministradorService().getUltimoCodigoAdministrador();
        } catch (Exception ex) {
//            Logger.getLogger(NuevoAdministradorFrame.class.getName()).log(Level.SEVERE, null, ex);
            cod = 0;
        }
